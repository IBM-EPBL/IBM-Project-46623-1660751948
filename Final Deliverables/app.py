...
def request_page():
    ...
    if request.method == 'POST':
        ...
        html_content = "<html><body><h1>Plasma Donation</h1><p><h2>%s blood was request.<h2><br><h3>Contect info: <h3><br><h4>Email id:<h4>%s,<br><h4>Mobile NO:<h4>%s,<br><h4>Address:<h4>%s.</p></body></html>"%(blood_type ,ibm_db.result(record2,1),ibm_db.result(record2,3),ibm_db.result(record2,5))
